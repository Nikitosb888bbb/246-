...
if (temp>=36 or temp<=37) and (pressure>=110 or pressure<=130) and (puls>=60 or puls<=100):
    print ('Все хорошо, никаких действий не требуется.')
elif ((temp>=35) and (temp<=36) or ((temp>=37) and (temp<=38))) and ((pressure>=105) and (pressure<=110)) or ((pressure>=130) and (pressure <=140)) and ((puls>=55 and puls<=60) or (puls>=100 and puls<=110)):
